...
class LevelChartTwo extends Component {
	constructor() {
		super();
		this.options = {};
	...
	render() {	
		this.options = {
			"New vs Loss": [{
				...
				type: "doughnut",
				dataPoints: [
					{ y: 522460, name: "Profit", color: "rgba(1, 151, 252, 0.671)" },
					{ y: 407040, name: "Loss", color: "gray" }
				]
			}],
			"Profit": [{
				color: "rgba(1, 151, 252, 0.671)",
				name: "Profit",
				type: "column",
				dataPoints: [
