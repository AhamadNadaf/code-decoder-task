...
class LevelChartOne extends Component {
	constructor() {
		super();
		this.options = {};
	...
	render() {	
		this.options = {
			"New vs Loss": [{
				...
				type: "doughnut",
				dataPoints: [
					{ y: 622460, name: "Profit", color: "rgba(231, 199, 18, 0.651)" },
					{ y: 997040, name: "Loss", color: "gray" }
				]
			}],
			"Profit": [{
				color: "rgba(231, 199, 18, 0.651)",
				name: "Profit",
				type: "column",
				dataPoints: [
		...
		<div>
			<CanvasJSChart options = {this.options} 
				 ...
				 containerProps={{ width: '100%', height: '200px' , bordeRadius:"10px"}} 
